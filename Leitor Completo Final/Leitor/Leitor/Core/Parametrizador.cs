    ...
    public class Parametrizador
    {
        ...
        private void Parametrizar(String arquivo, Remetente r)
        {
            ...
            if (_rgxModel.IsValid() && !_rgxModel.IsXpath)
            {
                ...
                _nota.infNFe.ide.tpEmis = //alteração pedida por fábio em 10/07 via skypeUtil.FormataData(geral.Groups[_rgxModel.GetKeyValue("RGX_ide_dEmi")].Value.Trim());
            ...
            else
            {
                ...
                if (_rgxModel.IsXpath)
                {
                    ...
                    _nota.infNFe.ide.tpEmis = //alteração pedida por fábio em 10/07 via skypeUtil.FormataData(XpathSingleNode(doc, _rgxModel.GetKeyXPath("RGX_ide_dEmi")));
